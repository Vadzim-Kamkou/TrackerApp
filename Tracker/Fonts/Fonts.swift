...
struct Fonts {
    ...
    static let ysDisplayMedium17 = UIFont(name: ysDisplayMediumFontName, size: 17)
    static let ysDisplayMedium16 = UIFont(name: ysDisplayMediumFontName, size: 16)
    static let ysDisplayMedium12 = UIFont(name: ysDisplayMediumFontName, size: 12)
